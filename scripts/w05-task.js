...
// Assuming the element with ID 'filtered' is a <select> element
const filteredElement = document.querySelector('#filtered');

// Add event listener to the 'change' event
filteredElement.addEventListener('change', () => {
    // Call filterTemples function with templeList as argument
